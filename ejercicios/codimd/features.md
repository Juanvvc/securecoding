---
title: CodiMD para INCIDE
---

# INCIDE

Listado de características útiles y chuletas.

## Comandos especiales para informes

### Cuadros

:::info
Cuadro para información solo para incide. En general puede usarse para comentar párrafos enteros, aunque con limitaciones: tiene que poder compilarse
::: 

:::success
Cuadro para conclusiones
:::

:::warning
Cuadro para cosas para mirar nostros
:::

:::danger
Cuadro para recomendaciones, avisos a cliente...
:::

> [name=jvera]
> Cuadro alternativo para comentarios y revisiones. No llegarán al LaTeX


### Tablas

[[[inlinetable("Caption de la figura, con comas",cm{2cm},tab:etiqueta)]]]
Cabecera|cabecera
--|--
1|Puede tener **formato**
3|4

Puede hacerse referencia a la tabla como: \ref{tab:etiqueta}

### Figuras

En el latex se verá como página en horizontal

`\begin{landscape}`{=latex}

![Histrograma de fechas de modificación de los archivos presentes en las fuentes, según sean correos (msg) u otros. Está expuesto en escala logarítmica para facilitar la observación de los archivos menos abundantes en ciertas fechas](https://hackmd.incide.es/uploads/upload_b2af5567c69cea0916a57c9faa0749a8.png){width=1.5\textwidth #fig:etiqueta}

`\end{landscape}`{=latex}

Puede hacerse referencia a la tabla como: \ref{fig:etiqueta}


## Solo disponibles en CodiMD

:::warning
Nada de lo siguiente llega al LaTeX. Para usarlos en informes, tienes que hacer captura de pantalla y pegar como imagen.
:::
...
### Soporte directo a archivos CSV
